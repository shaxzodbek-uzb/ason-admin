...
Nova.booting(function (Vue, router, store) {
    Vue.component('index-product-property', __webpack_require__(4));
    Vue.component('detail-product-property', __webpack_require__(7));
    Vue.component('form-product-property', __webpack_require__(11));
});
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__storage_ProductProperty__ = __webpack_require__(9);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    mounted: function mounted() {
        ...
        __WEBPACK_IMPORTED_MODULE_0__storage_ProductProperty__["a" /* default */].fetchAvailableResources(this.resourceId, null).then(function (_ref) {
            var _ref$data = _ref.data,
                properties = _ref$data.properties,
                product_properties = _ref$data.product_properties;

            for (var i in properties) {
                var item = properties[i];
                _this.rows.push({ id: item.id, name: item.name, property_value_id: 0, values: item.values });
            }
            for (var _i in _this.rows) {
                var _item = _this.rows[_i];

                for (var _i2 in product_properties) {
                    var item1 = product_properties[_i2];
                    if (item1.property_id == _item.id) {
                        _item.property_value_id = item1.property_value_id;
                        break;
                    }
                }
            }
    ...
    methods: {
        saveChanges: function saveChanges() {
            ...
            __WEBPACK_IMPORTED_MODULE_0__storage_ProductProperty__["a" /* default */].savePropertyChanges(this.resourceId, props).then(function (_ref2) {
                var data = _ref2.data;
...
/* harmony default export */ __webpack_exports__["a"] = ({
    fetchAvailableResources: function fetchAvailableResources(productId, params) {
        return Nova.request().get("/nova-api/product-properties/" + productId + "/list", params);
    },
    savePropertyChanges: function savePropertyChanges(productId, params) {
        return Nova.request().post("/nova-api/product-properties/" + productId + "/save", params);
    },
      ...
      _c(
        ...
        [
          _vm._l(_vm.rows, function(row) {
            return _c("div", { key: row.id, staticClass: "flex" }, [
              _c("div", { staticClass: "w-3/4 py-3 mr-1" }, [
                _c("input", {
                  directives: [
                    {
                      name: "model",
                  ...
                  attrs: { type: "text", placeholder: "Key", disabled: true },
                ...
                [
                  _c(
                    "select-control",
                    {
                      ...
                      model: {
                        value: row.property_value_id,
                        callback: function($$v) {
                          _vm.$set(row, "property_value_id", $$v)
                        },
                        expression: "row.property_value_id"
                      }
                    },
                    [
                      _c("option", { domProps: { value: 0 } }, [_vm._v("—")]),
                      _vm._v(" "),
                      _vm._l(row.values, function(option) {
                        return _c(
                          "option",
